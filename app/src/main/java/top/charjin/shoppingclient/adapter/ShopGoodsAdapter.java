...
public class ShopGoodsAdapter extends RecyclerView.Adapter<ShopGoodsAdapter.ViewHolder> {
    ...
    public ShopGoodsAdapter(Context context, List<OsGoods> data, ItemClickListener itemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.shop_list_item_goods, parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            iv_pic = view.findViewById(R.id.iv_list_item_shop_goods_pic);
            tv_title = view.findViewById(R.id.tv_list_item_shop_goods_title);
            tv_price = view.findViewById(R.id.tv_list_item_shop_goods_price);
            tv_sale_volume = view.findViewById(R.id.tv_list_item_shop_goods_sale_volume);
        }
    }
}